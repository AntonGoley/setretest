...
public class ManualDocsGeneralTest extends MainCashConfigTest {
	...
	public void test() throws Exception{
		MainCashDoc doc = docs.getDocByTypeAndNumber(DOC_TYPE_PKO_CASH_EXCESS, 2);
		docs.printDoc(doc);
		log.info(doc);
	}
	
	@Test(enabled = false, description = "SRTE-175. Автомтическое заполнение полей документов ПКО/РКО при создании (автор, дата и время создания, номер документа)",
