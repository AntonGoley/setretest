...
public class FlexMediator {
	...
	public static void checkBoxValue(WebDriver driver, String swfSrc, String checkBox, boolean checkBoxValue) {
		ecxecute(driver, String.format("document.getElementById('%s').doFlexCheckBox('%s', '%s')", swfSrc, checkBox, checkBoxValue));	
	}
